...
Rebuilds are triggered only if Debian builds a new image, or if one of the [`debuerreotype`](https://github.com/debuerreotype/debuerreotype) base packages were updated. Currently we create images for **Debian 13 "Trixie"**, **Debian 12 "Bookworm"**, and **Debian 11 "Bullseye"**. Please note that we might add or drop branches at any time, but usually around upstream's release resp. end-of-life dates.
